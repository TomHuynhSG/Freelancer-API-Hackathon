...
if ( ! function_exists( 'x_enqueue_site_scripts' ) ) :
  function x_enqueue_site_scripts() {
    ...
    wp_register_script( 'x-site-head', X_TEMPLATE_URL . "/framework/js/dist/site/x-head$ext", array( 'jquery' ), X_ASSET_REV, false );
    wp_register_script( 'x-site-body', X_TEMPLATE_URL . "/framework/js/dist/site/x-body$ext", array( 'jquery' ), X_ASSET_REV, true );
    wp_register_script( 'x-site-icon', X_TEMPLATE_URL . "/framework/js/dist/site/x-icon$ext", array( 'jquery' ), X_ASSET_REV, true );
    ...
    if ( X_BUDDYPRESS_IS_ACTIVE ) {
      ...
      wp_enqueue_script( 'x-site-buddypress', X_TEMPLATE_URL . '/framework/js/dist/site/x-buddypress.js', bp_core_get_js_dependencies(), X_ASSET_REV, false );
...
if ( ! function_exists( 'x_enqueue_post_meta_scripts' ) ) :
  function x_enqueue_post_meta_scripts( $hook ) {
    ...
    if ( strpos( $hook, 'x-addons' ) !== false ) {
      wp_register_script( 'x-addons-home-js', X_TEMPLATE_URL . "/framework/js/dist/admin/x-addons-home{$ext}", array( x_tco()->handle( 'admin-js' ) ), X_ASSET_REV, true );
...
if ( ! function_exists( 'x_enqueue_customizer_controls_scripts' ) ) :
  function x_enqueue_customizer_controls_scripts() {
    ...
    wp_register_script( 'x-customizer-controls-js', X_TEMPLATE_URL . "/framework/js/dist/admin/x-customizer-controls$ext", array( 'jquery' ), X_ASSET_REV, true );
...
if ( ! function_exists( 'x_enqueue_customizer_preview_scripts' ) ) :
  function x_enqueue_customizer_preview_scripts() {
    ...
    wp_register_script( 'x-customizer-preview-js', X_TEMPLATE_URL . "/framework/js/dist/admin/x-customizer-preview$ext", array( 'jquery', 'customize-preview', 'heartbeat' ), X_ASSET_REV, true );
