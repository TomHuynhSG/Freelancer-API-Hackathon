            ...
            menu: [
                ...
                },
                {
                    ...
                    menu: [
                           ...
                           menu: [
                                ...
                                },
                                {
                                ...
                                },
                                 {
                                    ...
                                    value: '[button size="medium" style="alt-button primary"  text="Medium button" link="http://" target=""]',
                                    onclick: function(e) {
                                        e.stopPropagation();
                                        editor.insertContent(this.value());
                                    }       
                                },
                                {
                                    ...
                                    value: '[button size="medium" style="alt-button secondary"  text="Medium button" link="http://" target=""]',
                                    onclick: function(e) {
                                        e.stopPropagation();
                                        editor.insertContent(this.value());
                                    }       
                                },
                                {
                                    ...
                                    value: '[button size="medium" style="alt-button success"  text="Medium button" link="http://"]',
                                    onclick: function(e) {
                                        e.stopPropagation();
                                        editor.insertContent(this.value());
                                    }       
                                },
                                {
                                    ...
                                    value: '[button size="medium" style="alt-button white"  text="Medium button" link="http://"]',
                                    onclick: function(e) {
                                        e.stopPropagation();
                                        editor.insertContent(this.value());
                                    }       
                        ...
                        {
                            text: 'Instagram Feed',
                            value: '[ux_instagram_feed username="yourusername" photos="999" text="Show more.."]',
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
                        ...
                        },
                        {
                            ...
                            menu: [
                             {
                                    text: 'Follow Icons',
                                    value: '[follow twitter="http://" facebook="http://" email="email@post.com" pinterest="http://" rss="http://" instagram="http://" googleplus="http://" tumblr="http://" vk="http://"]',
                                    onclick: function(e) {
                                        e.stopPropagation();
                                        editor.insertContent(this.value());
                                    }       
                                },
                                {
                                    ...
                                    value: '[follow size="small" twitter="http://" facebook="http://" email="email@post.com" pinterest="http://" rss="http://" instagram="http://" googleplus="http://" tumblr="http://" vk="http://"]',
                                    onclick: function(e) {
                                        e.stopPropagation();
                                        editor.insertContent(this.value());
                                    }       
                        ...
                        ,
                        {
                            ...
                            menu: [
                                 {
                                        text: 'Simple Countdown Text',
                                        value: '[ux_countdown  year="2016" month="12" day="30" time="24:00" size="100%" style="text"]',
                                        onclick: function(e) {
                                            e.stopPropagation();
                                            editor.insertContent(this.value());
                                        }  
                                ...
                                {
                                        text: 'Countdown Clock - Dark',
                                        value: '[ux_countdown year="2016" month="12" day="30" time="24:00" size="400%" style="clock"]',
                                        onclick: function(e) {
                                            e.stopPropagation();
                                            editor.insertContent(this.value());
                                        }
                                ...
                                {
                                        text: 'Countdown Clock - Light',
                                        value: '[ux_countdown year="2016" month="12" color="light" day="30" time="24:00" size="400%" style="clock"]',
                                        onclick: function(e) {
                                            e.stopPropagation();
                                            editor.insertContent(this.value());
                                        }
                                ...
                                {
                                        text: 'Countdown Clock - Primary Color',
                                        value: '[ux_countdown year="2016" month="12" color="primary" day="30" time="24:00" size="400%" style="clock"]',
                                        onclick: function(e) {
                                            e.stopPropagation();
                                            editor.insertContent(this.value());
                                        }
                                ...
                                {
                                        text: 'Countdown Clock - Transparent',
                                        value: '[ux_countdown year="2016" month="12" color="transparent" day="30" time="24:00" size="400%" style="clock"]',
                                        onclick: function(e) {
                                            e.stopPropagation();
                                            editor.insertContent(this.value());
                                        }
...
function ux_add_uxbanner(editor){
    ...
    editor.windowManager.open( {
        ...
        onsubmit: function( e ) {
            var banner_content = '[ux_banner bg="'+ux_selected_image+'" '+e.data.height+' '+e.data.text_color+' '+e.data.text_layout+'  '+e.data.parallax_text+' '+e.data.parallax+' '+e.data.text_animation+' '+e.data.banner_effect+']'+e.data.text_content+'[/ux_banner]';
