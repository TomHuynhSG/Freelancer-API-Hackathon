...
?>
 ...
 <div class="product-image">
			...
			<?php
				...
				echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<div class="slide easyzoom first is-selected"><a href="%s" itemprop="image" class="woocommerce-main-image zoom" title="%s">%s</a></div>', $image_link, $image_caption, $image ), $post->ID );
			?>
